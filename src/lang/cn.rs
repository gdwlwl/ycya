...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "状态"),
        ("Your Desktop", "远程鸭"),
        ("desk_tip", "远程连接 ID 和密码"),
        ("Password", "密码"),
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ("connecting_status", "正在连接 远程鸭服务器 请稍后..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动服务"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "当前为运行模式，可能会出现无法控制鼠标键盘或录制屏幕，建议点击下面的按钮将 远程鸭 安装到系统。"),
        ("Click to upgrade", "点击这里升级"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 远程鸭 \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 远程鸭 \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("setup_server_tip", "欢迎使用英可瑞 远程鸭^_^"),
        ...
        ("android_input_permission_tip1", "为了让远程设备通过鼠标或触屏控制您的安卓设备，你需要允许 远程鸭 使用\"无障碍\"服务。"),
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [远程鸭 Input] 服务开启。"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep RustDesk background service", "保持 远程鸭 后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 远程鸭 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on boot", "开机自启动"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予 远程鸭 \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予 远程鸭 \"录音\"权限。"),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运行 远程鸭 的 UAC 窗口点击确认。"),
        ...
        ("verify_rustdesk_password_tip", "验证 远程鸭 密码"),
        ...
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持 远程鸭 后台服务"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "请在远程端将 远程鸭 客户端升级至版本 {} 或更新版本！"),
